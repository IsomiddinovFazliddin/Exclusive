        ...
        <div className="container mx-auto flex items-center justify-between gap-10">
          ...
          <div className="w-[40%] pl-10">
            ...
            <div className="flex gap-4 justify-center items-center">
              <h5 className="font-Poppins font-normal text-[16px] leading-6 text-MainColor">Already have account?</h5>
              <span className="font-Poppins font-medium text-[16px] leading-6 text-MainColor border-b border-[#4D4D4D] cursor-pointer">Log in</span>
            </div>
          </div>
        </div>
      </div>
